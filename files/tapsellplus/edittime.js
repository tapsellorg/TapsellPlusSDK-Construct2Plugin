function GetPluginSettings() {
	return {
		...
		"id": "TapsellPlus",				// this is used to identify this plugin and is saved to the project; never change it
...
AddCondition(1, cf_trigger, "Request response", "Tapsell Plus",
	"If ad is available for zone {0}", "Ad is available", "requestResponse");

AddStringParam("Zone Id", "Id of zone for which ad is available.");
AddCondition(2, cf_trigger, "Request error", "Tapsell Plus",
	"If request returned error for zone {0}", "On rrror", "requestError");
...
AddStringParam("Zone Id", "Id of zone from tapsell dashboard")
AddAction(0, af_none, "Request interstitial", "Tapsell Plus",
	"Request a interstitial ad for zone with id {0}", "Request interstitial ad",
	"requestInterstitial");
